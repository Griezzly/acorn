...
const (
	...
	BenchmarkOrchestrator_StartBenchmark_FullMethodName = "/benchmark.BenchmarkOrchestrator/StartBenchmark"
)
...
type BenchmarkOrchestratorClient interface {
	...
	StartBenchmark(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ExecutionAck, error)
}
...
func (c *benchmarkOrchestratorClient) StartBenchmark(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ExecutionAck, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExecutionAck)
	err := c.cc.Invoke(ctx, BenchmarkOrchestrator_StartBenchmark_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BenchmarkOrchestratorServer interface {
	...
	StartBenchmark(context.Context, *emptypb.Empty) (*ExecutionAck, error)
...
func (UnimplementedBenchmarkOrchestratorServer) StartBenchmark(context.Context, *emptypb.Empty) (*ExecutionAck, error) {
...
func _BenchmarkOrchestrator_StartBenchmark_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BenchmarkOrchestratorServer).StartBenchmark(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BenchmarkOrchestrator_StartBenchmark_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BenchmarkOrchestratorServer).StartBenchmark(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BenchmarkOrchestrator_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BenchmarkOrchestrator_StartBenchmark_Handler,
		},
	},
